...
CREATE DATABASE IF NOT EXISTS `kitap_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci */;
USE `kitap_db`;
...
-- kitap_db.kitaplar: 101 rows tablosu için veriler indiriliyor
...
INSERT INTO `kitaplar` (`ID`, `adi`, `yazarID`, `dilID`, `sayfaSayisi`, `yayineviID`, `ozet`, `yayinTarihi`, `resim`) VALUES
	...
	(201, 'testing book', 41, 1, 500, 1, 'asa sdfa sdfa', '2023-04-12', '2.jpg');
/*!40000 ALTER TABLE `kitaplar` ENABLE KEYS */;

-- tablo yapısı dökülüyor kitap_db.turler
CREATE TABLE IF NOT EXISTS `turler` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `turAdi` char(50) CHARACTER SET latin5 NOT NULL,
  `Sira` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;

-- kitap_db.turler: 11 rows tablosu için veriler indiriliyor
